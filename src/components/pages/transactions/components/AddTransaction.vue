                ...
                <form class="row g-3 needs-validation" novalidate>
                    <div class="col-md-6">
                        <div class="form-floating">
                            <input type="date" class="form-control" id="transactionDateField" v-model="transactionToSubmit.transaction.date"
                                v-bind:class="{
                    ...
                    <div class="col-md-6">
                        <div class="form-floating">
                            <input type="text" class="form-control" placeholder="Description"
                                id="transactionDescriptionField" v-model="transactionToSubmit.transaction.description" v-bind:class="{
                                    'form-control': true,
                    ...
                    <div class="col-md-6">
                        <div class="form-floating">
                            <input type="number" class="form-control" placeholder="Value" id="transactionValueField"
                                step=".01" v-model="transactionToSubmit.transaction.value" v-bind:class="{
                                    'form-control': true,
                    ...
                    <div class="col-md-6">
                        <div class="form-floating mb-3">
                            <select class="form-select" id="categoryCombobox" aria-label="Category"
                                v-model="transactionToSubmit.transaction.categoryId" v-bind:class="{
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="col-sm-6">
                            <div class="form-check">
                                <input class="form-check-input" type="radio" name="splitRadios" value="true"
                                    id="splitIntoAllCategories" v-model="transactionToSubmit.splitIntoCategories" v-bind:class="{
                            ...
                            <div class="form-check">
                                <input class="form-check-input" type="radio" name="splitRadios" value="false"
                                    id="doNotSplitIntoAllCategories" v-model="transactionToSubmit.splitIntoCategories" v-bind:class="{
                                        'is-invalid': !isSplitOptionValid() && transactionToSubmit.attemptedToSubmit,
                                        'is-valid': isSplitOptionValid() && transactionToSubmit.attemptedToSubmit,
                                    }" required />
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="col-sm-6">
                            <div class="form-check">
                                <input class="form-check-input" type="radio" name="typeRadios" value="false"
                                    id="transactionIncomeType" v-model="transactionToSubmit.transaction.isExpense" v-bind:class="{
                            ...
                            <div class="form-check">
                                <input class="form-check-input" type="radio" name="typeRadios" value="true"
                                    id="transactionExpenseType" v-model="transactionToSubmit.transaction.isExpense" v-bind:class="{
                                        'is-invalid': !isTypeValid() && transactionToSubmit.attemptedToSubmit,
                                        'is-valid': isTypeValid() && transactionToSubmit.attemptedToSubmit,
                                    }" required />
                    ...
                    <div class="text-center">
                        <button type="button" class="btn btn-primary" id="addTransactionButton"
...
function getSelectedPeriod(): Period{
    ...
    let foundPeriod = transactionToSubmit.value.periods.find((p) => date >= new Date(p.startDate) && date < new Date(p.endDate));
...
function isCategoryValid(): boolean{
    ...
    if(transactionToSubmit.value.transaction.categoryId != 0 || isSplitIntoCategoriesSelected() == true){
...
function isFormValid(): boolean{
    ...
    if(isDateValid() == true && isValueValid() == true && isDescriptionValid() == true && isCategoryValid() == true && isTypeValid() == true && isSplitOptionValid() == true){
        formIsValid = true;
    }
...
function getTransactionsToBeAdded(){
    ...
    if(isFormValid() == true){
        ...
        if(transactionToSubmit.value.splitIntoCategories == false){
            transactionsToBeAdded.push(transactionToSubmit.value.transaction);
        }
        else{
